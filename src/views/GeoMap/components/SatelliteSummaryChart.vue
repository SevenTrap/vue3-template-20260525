  ...
  >
    ...
    <template #default>
      <div class="my-content">
        <div class="satellite-summary-chart" ref="satelliteSummaryChartContainer"></div>
      </div>
    </template>
  </el-dialog>
</template>
...
export default {
  ...
  methods: {
    ...
    initChartData() {
      ...
      const summaryChartData = calculateSummaryChartData(satelliteNoradIDs, satelliteTles, startTime, endTime);
      this.summaryChartData = summaryChartData;
    },

    updateChart() {
      const summaryChartData = this.summaryChartData;
      ...
      for (let si = 0; si < summaryChartData.length; si++) {
        const currentSeriesData = [];
        const currentSatelliteData = summaryChartData[si];
